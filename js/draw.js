...
var id, js, ids, pad, back, feed, json, init, link, size, test, type, style, skema, select, params, draw = {
    ...
    getScript : function(item) {
        ...
        $.getScript(js, function( data, textStatus, jqxhr ) {
            ...
            try {
                ...
                if (type == 'Sitewheel') {initialize().then (function (control) {doTheTreeViz(control);});}
    ...
    element : function() {
        ...
        if (!$('#diagram, #graphiql').find('svg')[0]) {
            ...
            else if (type == 'Sitewheel') {elements = $('svg g node').hover(function() {$(this).hide(100).show(100);});}
